...
| 13900 | <a id="StatResourceProducedMultipleTypesCountEx">StatResourceProducedMultipleTypesCountEx</a><sub><br/>Returns the number of the specified resource types produced by the specified player.</sub> | <sub>**aHand**: Integer; <br/> **aTypes**: TKMWareTypeSet; // _Set of ware types eg. [wtCoal, wtIron, wtGold]_</sub> | <sub>Integer // Number of produced resources</sub> |
...
| 13900 | <a id="StatUnitKilledMultipleTypesCountEx">StatUnitKilledMultipleTypesCountEx</a><sub><br/>Returns the number of the specified unit types killed by the specified player.</sub> | <sub>**aHand**: Integer; <br/> **aTypes**: TKMUnitTypeSet;</sub> | <sub>Integer // Set of unit types eg. [utMilitia, utAxeFighter, utSwordFighter]</sub> |
